...
const ORDERED_FILES = [
  ...
  'start/ai-environment/claude-skill.md',
  'start/ai-environment/mcp-server.md',
  'start/ai-environment/openclaw.md',
  ...
  // Recipes
  'recipes/index.md',
  'recipes/provider-agent.md',
  'recipes/consumer-agent.md',
  'recipes/autonomous-agent.md',
  'recipes/gasless-payment.md',
  'recipes/per-call-api.md',
  'recipes/quote-negotiation.md',
  ...
  'reference/contracts/base-mainnet.md',
  'reference/contracts/base-sepolia.md',
  'reference/sdk-js/index.md',
  'reference/sdk-js/basic.md',
  'reference/sdk-js/standard.md',
