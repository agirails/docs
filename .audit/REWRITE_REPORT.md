...
<!-- METRICS:start -->
<!-- GENERATED by scripts/regen-report-metrics.ts on every truth-ledger build. Do not edit by hand. Source: static/sdk-manifest.json at 2026-05-29T10:42:13.126Z. -->
...
| Truth-ledger invariant test bodies | 56 | `grep -rc "it(" scripts/truth-ledger/__tests__` |
...
| Glossary cross-link occurrences | 287 | `grep -rc "/reference/glossary#" docs/` |
| Docs files in IA | 61 | `find docs -name "*.md" -not -path "*/img/*" \| wc -l` |
