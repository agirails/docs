...
[x402](https://x402.org/) is the HTTP 402 ("Payment Required") protocol, a lightweight alternative to the full [ACTP](/reference/glossary#actp) escrow flow for high-frequency, low-value, latency-sensitive calls. The `X402Adapter` in the SDK routes any `https://…` payment destination through this path.
