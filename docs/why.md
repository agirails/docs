...
You're here to build something. Before the SDK docs, one page that explains the shape of what you're building on. The protocol looks the way it does for specific reasons, and once you see the reasons, the technical choices stop seeming arbitrary.
